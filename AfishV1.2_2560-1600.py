...
monitor1 = {"top": 637, "left": 728, "width": 693, "height": 184}
monitor2 = {"top": 422, "left": 493, "width": 693, "height": 184}
...
min_contour_area1 = 0
max_contour_area1 = int(1100*1.779//1)
min_contour_area2 = int(1400*1.778//1)
max_contour_area2 = int(7000*1.778//1)
...
cv2.createTrackbar("Min Contour Area 1", "Capture Settings", min_contour_area1, 100000, update_min_contour_area1)
cv2.createTrackbar("Max Contour Area 1", "Capture Settings", max_contour_area1, 100000, update_max_contour_area1)
cv2.createTrackbar("Min Contour Area 2", "Capture Settings", min_contour_area2, 100000, update_min_contour_area2)
cv2.createTrackbar("Max Contour Area 2", "Capture Settings", max_contour_area2, 100000, update_max_contour_area2)
