...
cv2.createTrackbar('Min Area', 'Contours', min_area, 15000, lambda x: update_area(x, 'min'))
cv2.createTrackbar('Max Area', 'Contours', max_area, 15000, lambda x: update_area(x, 'max'))


# Инициализируем бинаризацию с начальным значением порога
update_binary(30)

# Заданные координаты области захвата экрана
left, top, width, height = 500, 100, 1000, 800
